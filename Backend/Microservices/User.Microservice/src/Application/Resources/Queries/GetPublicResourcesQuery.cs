...
public sealed class GetPublicResourcesQueryHandler
    : IRequestHandler<GetPublicResourcesQuery, Result<List<ResourcePresignResponse>>>
{
    private readonly IRepository<Resource> _repository;
    private readonly IObjectStorageService _objectStorageService;

    public GetPublicResourcesQueryHandler(IUnitOfWork unitOfWork, IObjectStorageService objectStorageService)
    {
    ...
    public async Task<Result<List<ResourcePresignResponse>>> Handle(
        GetPublicResourcesQuery request,
        CancellationToken cancellationToken)
    {
        ...
        var uniqueIds = request.ResourceIds
