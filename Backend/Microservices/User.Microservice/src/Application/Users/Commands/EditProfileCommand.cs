...
public sealed record EditProfileCommand(
    ...
    string? Address,
    DateTime? Birthday,
    Guid? AvatarResourceId) : IRequest<Result<AdminUserResponse>>;

public sealed class EditProfileCommandHandler
    : IRequestHandler<EditProfileCommand, Result<AdminUserResponse>>
{
    ...
    public async Task<Result<AdminUserResponse>> Handle(EditProfileCommand request,
