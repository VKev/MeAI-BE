...
internal static class BillingSeedCatalog
{
    ...
    [
        new(
            ...
            LegacySubscriptionNames: ["Subscription 10000"],
            CoinAmount: 10000m,
            ...
            LegacyCoinPackageNames: ["Coin Package 10000"],
            CoinPackageBonusCoins: 0m,
            CoinPackagePrice: 100000m,
            CoinPackageDisplayOrder: 1),
        new(
            SubscriptionName: "Pro",
            LegacySubscriptionNames: ["Subscription 15000"],
            CoinAmount: 15000m,
            ...
            LegacyCoinPackageNames: ["Coin Package 15000"],
            CoinPackageBonusCoins: 0m,
            CoinPackagePrice: 150000m,
            CoinPackageDisplayOrder: 2),
        new(
            SubscriptionName: "Pro Max",
            LegacySubscriptionNames: ["Subscription 20000"],
            CoinAmount: 20000m,
            ...
            ContentRate: 20,
            MaxPages: 50,
            CoinPackageName: "Pro Max Coins",
            LegacyCoinPackageNames: ["Coin Package 20000"],
            CoinPackageBonusCoins: 0m,
