...
public sealed record GetWorkspaceAiResourcesQuery(
    Guid WorkspaceId,
    Guid UserId,
    IReadOnlyList<string>? ResourceTypes)
    : IRequest<Result<IEnumerable<WorkspaceAiResourceResponse>>>;

public sealed class GetWorkspaceAiResourcesQueryHandler
    : IRequestHandler<GetWorkspaceAiResourcesQuery, Result<IEnumerable<WorkspaceAiResourceResponse>>>
{
    ...
    public GetWorkspaceAiResourcesQueryHandler(
    ...
    public async Task<Result<IEnumerable<WorkspaceAiResourceResponse>>> Handle(
        GetWorkspaceAiResourcesQuery request,
        CancellationToken cancellationToken)
    {
        ...
        var sessions = (await _chatSessionRepository
                .GetByWorkspaceIdAsync(request.UserId, request.WorkspaceId, cancellationToken))
