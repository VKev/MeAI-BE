...
public sealed record GetVideoStatusQuery(Guid UserId, Guid CorrelationId) : IRequest<Result<VideoTaskStatusResponse>>;
    ...
    : IRequestHandler<GetVideoStatusQuery, Result<VideoTaskStatusResponse>>
{
        ...
        CancellationToken cancellationToken)
    {
        ...
        {
            return Result.Failure<VideoTaskStatusResponse>(VeoErrors.Unauthorized);
        }
