...
11. Tạo một runtime `PostBuilder`.
12. Tạo một runtime `Post` cho mỗi platform group trong cùng builder.
13. Publish thẳng từng runtime `Post` tới đúng targets của platform group đó.
